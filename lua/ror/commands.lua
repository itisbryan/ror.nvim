...
function M.list_commands()
	...
	vim.ui.select({
		...
		"Find service tests",
		"Find types (GRAPHQL)",
		"Find mutations (GRAPHQL)",
		"Find resolvers (GRAPHQL)",
		...
		elseif command == "Find service tests" then
			close_floating_window()
			require("ror.finders.service_test").find()
		elseif command == "Find types (GRAPHQL)" then
			close_floating_window()
			require("ror.finders.graphql_type").find()
		elseif command == "Find mutations (GRAPHQL)" then
			close_floating_window()
			require("ror.finders.graphql_mutation").find()
		elseif command == "Find resolvers (GRAPHQL)" then
			close_floating_window()
